...
/**
 * Given a SQL *query* sentence, try to parse it into different parts, mainly
 * using ZQL.
 * 
 * @author shu
 */
public class SQLParser {
	...
	/**
	 * Parse out different sections of a sql sentence. The result is stored in a
	 * K-V manner. Now supports: "columns", "tables".
	 * 
	 * @param sql
	 * @return
	 * @throws ParseException
	 */
	public Hashtable<String, List<String>> parseSQL(String sql)
			throws ParseException {
...
/**
	 ...
	 * @throws ParseException
	 */
	public HashMap<String, Object> parseWhere(String sql) throws ParseException {
	...
	/**
	 * Testing More test casees could be found from
